...
export const ChangingGrid = (props) => {
    ...
    const initData = () => { 
        ...
        for (let i = 0 ; i < props.mainParams.length ; i++) {
            console.log("paramName : " + props.mainParams[i]['paramName']);
            let tempParam = props.mainParams[i]['paramName'];
    ...
    //         console.log( "paramName : " + props.paramsData[i])
    //         let tempParamName = props.paramsData[i]['paramsName']
    //         tempParams.push(tempParamName)
    //     }
    ...
    return(
        <div>
            ...
            <Box sx={{alignItems: " center"}}>
                ...
                <Button variant="outlined" onClick={() => console.log(props.mainParams)} >show paramsData</Button>
                <Button variant="outlined" onClick={() => console.log(data)} >show data</Button>
                <Button variant="outlined" onClick={initData} >init data</Button>
